...
export async function GET(request: Request) {
  try {
    ...
    // 2. Chuyển URL thành Slug - DÙNG downloadedUrls[0] vì slug trong DB được tính từ URL chapter
    ...
    // 5. Build txt string
    let content = `Truyện: ${story.title}\nNguồn: ${storyUrl}\n\n`;
    ...
    return new NextResponse(content, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="Story_${storySlug}_Ch_${minCh}-${maxCh}.txt"`
      }
    });
