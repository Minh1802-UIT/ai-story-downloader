...
async function testFullManual() {
    ...
    const url = `${WSS_URL}?TrustedClientToken=${TRUSTED_CLIENT_TOKEN}&Sec-MS-GEC=${secMsGEC}&Sec-MS-GEC-Version=1-130.0.2849.68&ConnectionId=${req_id}`;
    ...
    return new Promise((resolve, reject) => {
        ws.on('open', () => {
            ...
            const text = "Xin chào, đây là kiểm tra bảo mật.";
...
testFullManual().catch(console.error);
